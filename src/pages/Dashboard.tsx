...
const Dashboard = () => {
  const { currentSite, posts, pages, users, plugins, fetchPosts, fetchPages, fetchUsers, fetchPlugins } = useWordPress()
  ...
  const generateMockMetrics = () => {
    ...
    return {
      ...
      securityOverview: {
        ...
        vulnerabilities: 1,
        lastScan: new Date(),
        issues: [{ severity: "medium" as const, message: "Outdated plugin detected" }],
      },
      contentOverview: {
        posts: posts.length,
        pages: pages.length,
