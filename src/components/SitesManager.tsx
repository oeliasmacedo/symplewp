        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {sites.map((site) => (
            ...
            >
              ...
              <CardContent>
                <div className="text-sm text-muted-foreground mb-4 truncate">{site.url}</div>
              ...
              <CardFooter className="pt-1 text-xs text-muted-foreground">
                {site.lastConnected && <span>Last connected: {format(new Date(site.lastConnected), "PPP")}</span>}
              </CardFooter>
            </Card>
          ))}
        </div>
