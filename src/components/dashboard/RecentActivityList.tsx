...
export function RecentActivityList() {
  ...
  const generateActivities = () => {
    ...
    if (posts && posts.length > 0) {
      ...
      const recentPosts = [...posts].sort((a, b) => new Date(b.date).getTime() - new Date(a.date).getTime()).slice(0, 2)
    ...
    <Card>
      <CardHeader className="flex flex-row items-center justify-between">
        <div>
          ...
          <CardDescription>Latest actions and updates from your site</CardDescription>
        </div>
