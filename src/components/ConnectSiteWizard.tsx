...
import type { WordPressConnectionCredentials } from "@/types/wordpress"
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>Connect your WordPress site to manage it remotely</DialogDescription>
        </DialogHeader>
        ...
        {step === 1 && (
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">Enter the complete URL of your WordPress site</p>
            </div>
